...
export const Features = () => {
  ...
  const handleSelectTab = (index: number) => {
    ...
    animate(backgroundSizeX, [backgroundSizeX.get(), 100, tabs[index].backgroundSizeX], animationOptions,);
    animate(backgroundPositionX, [backgroundPositionX.get(), tabs[index].backgroundPositionX],animationOptions,);
    animate(backgroundPositionY, [backgroundPositionY.get(), tabs[index].backgroundPositionY], animationOptions);
  };
