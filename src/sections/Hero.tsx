...
export const Hero = () => {
  ...
  const backgroundPositionX = useTransform(scrollYProgress, [0, 1], [-300, 300]);
  ...
  <div className='absolute inset-0 bg-[radial-gradient(75%_75%_at_center_center,rgb(140,69,255,.5)_15%,rgb(14,0,36,.5)_78%,transparent)]'></div>
    ...
    <div className="container relative mt-16">
      <h1 className='text-8xl m:text-[168px] md:leading-none font-semibold tracking-tighter bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] text-transparent bg-clip-text text-center'>AI SEO</h1>
      <p className='text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto'>Elevate your sites visibility effortlessly with AI, where smart technology meets user-friendly SEO tools.</p>
